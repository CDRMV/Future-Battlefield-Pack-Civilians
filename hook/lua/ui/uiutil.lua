...
LOG('Future Battlefield Pack Civilians: [uiutil.lua '..debug.getinfo(1).currentline..'] - Gameversion is older then 3652. Hooking "UIFile" to add our own unit icons')
...
local MyUnitIdTable = {
   ...
   URC1016=true, -- Cybran Road (South to North Edge Curve 2)
	...
	LOG('Future Battlefield Pack Civilians: [uiutil.lua '..debug.getinfo(1).currentline..'] - Gameversion is 3652 or newer. No need to insert the unit icons by our own function.')
